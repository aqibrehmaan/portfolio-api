                ...
                <div class="content-header">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown d-inline-block ml-2">
                            ...
                            }}" alt="Profile Image" height="21px" width="21px">
                            @else
                            ...
                            @if (!empty(auth()->user()->profile_photo_path))
                                    <img class="rounded-circle" src="{{url('storage/'.auth()->user()->profile_photo_path)
                                    }}
                                    " alt="Profile Image" height="48px" width="48px">
                                @else
                                ...
                                <div class="p-2">
                                    ...
                                    <div role="separator" class="dropdown-divider"></div>
                                        <a href="{{ route('logout') }}"
                                            onclick="event.preventDefault(); document.getElementById('logout-account-2').submit();" class="dropdown-item d-flex align-items-center justify-content-between">
                                            <span class="font-size-sm font-w500">Log Out</span>
                                        </a>
                                        <form id="logout-account-2" action="{{ route('logout') }}" method="POST"
                                            style="display: none;">
                                            @csrf
                                        </form>
                                </div>
